...
def testrender_system_prompt_fills_all_placeholders(isolated_db, isolated_workspace):
    bootstrap()

    output = render_system_prompt()
...
def testrender_system_prompt_inlines_memory_files(isolated_db, isolated_workspace):
